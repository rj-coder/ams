		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#inwesterncoalassetmanagementportal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"inwesterncoalassetmanagementportal-display": {
								"semanticObject": "inwesterncoalassetmanagementportal",
								"action": "display",
								"description": "Asset Management Portal using SAP Fiori UI5",
								"title": "Asset Management Portal",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=in.westerncoal.assetmanagementportal",
									"url": sap.ui.require.toUrl("in/westerncoal/assetmanagementportal")
								}
							}
						}
					}
